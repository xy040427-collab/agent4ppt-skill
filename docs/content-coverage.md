...
## Showcase refresh — 2026-09-22

README and Chinese entry now lead with a delivered 10-page full-slide-first comparison; `showcase-current.md` retains all-page previews, downloadable decks and bounded OOXML verification. Previous 30-page gallery, evidence, downloads and workflow references remain intact and are labeled historical. No runtime, style recipe or skill behavior changed. Only explicitly approved documentation images are excepted from the generated-image ignore rule.
